...
1. 下载 [ffmpeg](https://github.com/BtbN/FFmpeg-Builds/releases)（选 `ffmpeg-master-latest-win64`），解压到 `third_party/ffmpeg/`。
2. 下载 [NirCmd 64-bit](https://www.nirsoft.net/utils/nircmd.html)，解压到 `third_party/nircmd/`。
