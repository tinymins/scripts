...
# ffmpeg 路径（与本脚本同目录）
FFMPEG = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", ".vendor", "ffmpeg", "ffmpeg.exe")
FFPROBE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", ".vendor", "ffmpeg", "ffprobe.exe")
